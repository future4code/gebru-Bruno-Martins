// A função abaixo recebo por parâmetro  o ano atual, o ano de nascimento de 
// uma pessoa, e o ano em que sua carteira de identidade foi emitida (nessa ordem).
...
function checaRenovacaoRG(anoAtual:number, anoNascimento:number, anoEmissao:number ):string {
   ...
   console.log(checaRenovacaoRG(2022, 1993, 5))